/**
 * Created by king on 7/14/15.
 */



appController.controller("replyforumController",['$scope','ajaxService','shareService','$location','$modal','$filter','FileUploader','$stateParams',function($scope, ajaxService, shareService, $location,$modal, $filter, FileUploader, $stateParams){
